...
import { Github, Linkedin, Mail, Download, ArrowRight, ChevronRight, Terminal } from 'lucide-react'
...
export default function Page() {
    ...
    return (
        <main className="relative min-h-screen bg-white text-zinc-900 antialiased">
            <GridBackground />
            <VerticalRails />
            <header className="sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur">
                <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 md:px-6">
                    ...
                    <div className="flex items-center gap-2">
                        <Link aria-label="GitHub" href="https://github.com/your-handle">
                            <Button variant="outline" size="icon" className="h-8 w-8 border-zinc-300">
                                <Github className="h-4 w-4" />
                            </Button>
                        </Link>
                        <Link aria-label="LinkedIn" href="https://www.linkedin.com/in/your-handle">
                            <Button variant="outline" size="icon" className="h-8 w-8 border-zinc-300">
                                <Linkedin className="h-4 w-4" />
                            </Button>
                        </Link>
                        <Link aria-label="Email" href="mailto:you@example.com">
                        ...
                        <div className="flex flex-col gap-6">
                            <div>
                                ...
                                <p className="mt-2 text-zinc-600">
                                    Backend Engineer focused on scalable systems, data pipelines, and thoughtful APIs. I build reliable foundations so products can
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <MetaRow label="Location" value="Your City, Country" />
                                <MetaRow label="Role" value="Senior Backend Engineer" />
                                <MetaRow label="Open to" value="Full-time, Consulting" />
                                <MetaRow
                                    label="Contact"
                                    value={
                                        <div className="flex items-center gap-3">
                                            <Link className="underline underline-offset-4 hover:text-zinc-950" href="mailto:you@example.com">
                                                you@example.com
                                            </Link>
                                            <Separator orientation="vertical" className="h-4 bg-zinc-300" />
                                            <Link className="hover:text-zinc-950" href="https://github.com/your-handle">
                    ...
                    <Box title="Portrait">
                        <div className="relative">
                            <div className="relative overflow-hidden rounded-sm border border-zinc-200">
                                ...
                                />
                                <Image
                                    src="/backend-engineer-portrait.png"
                                ...
                                <div key={proj.name} className="flex flex-col rounded-sm border border-zinc-200">
                                    ...
                                    <div className="flex flex-1 flex-col p-4">
                                        ...
                                        <div className="mt-4 flex gap-2">
                                            <Link href="https://github.com/your-handle/your-repo">
                                ...
                                {[
                                    {
                                        ...
                                        years: "2022 — Present",
                                        bullets: [
                                            "Redesigned event pipeline to cut p99 latency from 450ms to 120ms.",
                                            "Led adoption of SLOs; incident rate down 38% YoY.",
                                        ],
                                    },
                                    {
                                        ...
                                        years: "2020 — 2022",
                                        bullets: [
                                            "Implemented multi-region read replicas; 5x throughput increase.",
                                            "Introduced idempotent APIs for safer retries and exactly-once semantics.",
                                        ],
                                    },
                                ].map((job) => (
                    ...
                    <Box title="Contact">
                        <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <Link href="https://cal.com/your-handle/intro">
                                    <Button variant="outline" className="gap-2 border-zinc-300">
                                        <ArrowRight className="h-4 w-4" />
                                        Book intro call
                                    </Button>
